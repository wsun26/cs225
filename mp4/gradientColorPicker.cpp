...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
    ...
    if(d <= rad){
    	color.red = fcolor1.red - floor(((d * fcolor1.red)/rad)) + floor(((d * fcolor2.red)/rad)); 
    	color.green = fcolor1.green - floor(((d * fcolor1.green)/rad)) + floor(((d * fcolor2.green)/rad)); 
    	color.blue = fcolor1.blue - floor(((d * fcolor1.blue)/rad)) + floor(((d * fcolor2.blue)/rad));
    	return color; 
    }
